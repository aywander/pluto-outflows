...
/* CLOUDS values. 
 * NO for no clouds */
#define SINGLE_CUBE     1

/* CLOUD_VELOCITY values 
 * Should cloud velocity be read from external data? YES/NO*/

/* CUBE_BYTESWAP values. 
 * Byte swapping, if necessary, YES or NO */

/* TCRIT <double> 
 * defines a critical temperature for thermal instability */
...
/* #######################################################
              include definitions_usr.h here 
   */
...
extern int g_idnvar, g_idvarindx[ID_MAX_NVAR];
