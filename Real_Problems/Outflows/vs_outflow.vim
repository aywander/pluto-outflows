...
silent only
cd ~/research/PLUTO/Real_Problems/Outflows
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +932 init_tools.c
badd +11 ~/research/PLUTO/Config/debug.defs
badd +11 ~/research/PLUTO4.0/Config/debug.defs
badd +25 definitions.h
badd +19 definitions_usr.h
badd +68 init.c
badd +1 pluto.ini
badd +1 pluto_jet.ini
badd +1 pluto_ufo.ini
badd +22 definitions_usr_jet.h
badd +4 definitions_usr_ufo.h
badd +544 ~/research/PLUTO/Src/pluto.h
badd +54 pluto_usr.h
badd +188 ~/research/PLUTO/Src/RHD/prim_eqn.c
badd +66 ~/research/PLUTO/Src/HD/prim_eqn.c
badd +103 ~/research/PLUTO/Src/macros.h
badd +335 macros_usr.h
badd +128 ~/research/PLUTO/Src/globals.h
badd +58 init_tools.h
badd +1 ~/research/PLUTO/Src/structs.h
badd +1 userdef_output.c
badd +45 gravity/rGravTable.c
badd +27 rHotTable.c
badd +125 ~/research/PLUTO/Src/prototypes.h
badd +0 local_make
badd +1 gravity/hottable.dat
badd +1 gravity/gravtable.hdr
args init_tools.c
edit init_tools.c
...
exe 'vert 3resize ' . ((&columns * 30 + 102) / 204)
argglobal
...
silent! normal! zE
let s:l = 635 - ((10 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
635
normal! 0
lcd ~/research/PLUTO/Real_Problems/Outflows
wincmd w
argglobal
edit ~/research/PLUTO/Real_Problems/Outflows/init_tools.h
setlocal noautoindent
setlocal nobinary
setlocal bufhidden=
setlocal buflisted
...
argglobal
enew
file ~/research/PLUTO/Real_Problems/Outflows/__Tag_List__
let s:cpo_save=&cpo
set cpo&vim
...
exe '3resize ' . ((&lines * 48 + 26) / 52)
exe 'vert 3resize ' . ((&columns * 30 + 102) / 204)
tabedit ~/research/PLUTO/Real_Problems/Outflows/init.c
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 429 - ((38 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
429
...
wincmd w
argglobal
edit ~/research/PLUTO/Real_Problems/Outflows/userdef_output.c
setlocal noautoindent
setlocal nobinary
setlocal bufhidden=
setlocal buflisted
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 41 - ((11 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
41
...
exe 'vert 1resize ' . ((&columns * 102 + 102) / 204)
exe 'vert 2resize ' . ((&columns * 101 + 102) / 204)
tabedit ~/research/PLUTO/Real_Problems/Outflows/pluto.ini
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 96 - ((0 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
96
...
lcd ~/research/PLUTO/Real_Problems/Outflows
2wincmd w
tabedit ~/research/PLUTO/Real_Problems/Outflows/pluto_usr.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 57 - ((44 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
...
lcd ~/research/PLUTO/Real_Problems/Outflows
2wincmd w
tabedit ~/research/PLUTO/Real_Problems/Outflows/definitions_usr_ufo.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
wincmd w
argglobal
edit ~/research/PLUTO/Real_Problems/Outflows/definitions_usr_jet.h
setlocal noautoindent
setlocal nobinary
setlocal bufhidden=
setlocal buflisted
...
wincmd w
argglobal
edit ~/research/PLUTO/Real_Problems/Outflows/definitions_usr.h
setlocal noautoindent
setlocal nobinary
setlocal bufhidden=
setlocal buflisted
...
exe '3resize ' . ((&lines * 48 + 26) / 52)
exe 'vert 3resize ' . ((&columns * 67 + 102) / 204)
tabedit ~/research/PLUTO/Real_Problems/Outflows/local_make
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
