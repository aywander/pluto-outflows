...
badd +123 init.c
badd +0 init_tools.c
badd +186 pluto_usr.h
badd +20 definitions_usr.h
badd +1 pluto.ini
badd +0 userdef_output.c
badd +4 abundances.c
badd +0 radiat.c
badd +0 cooling/rMuTable.c
badd +0 cooling/rMuTable.h
badd +0 ~/research/AGN_Feedback/Jet/05kpc/pluto.ini
badd +1 ~/research/AGN_Feedback/Jet/05kpc/IndexTMI.H
badd +76 ~/research/AGN_Feedback/Jet/05kpc/pluto_ufo.ini
badd +1 pluto_jet.ini
badd +0 ~/research/AGN_Feedback/Jet/05kpc/definitions_usr.h
badd +1171 pluto.h
args init.c
edit init_tools.c
...
silent! normal! zE
let s:l = 1063 - ((36 * winheight(0) + 29) / 59)
...
wincmd w
argglobal
edit ~/research/PLUTO/Real_Problems/Outflows/init_tools.c
setlocal noautoindent
setlocal nobinary
setlocal bufhidden=
setlocal buflisted
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 584 - ((51 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
584
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 132 - ((41 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
132
...
lcd ~/research/PLUTO/Real_Problems/Outflows
2wincmd w
tabedit ~/research/PLUTO/Real_Problems/Outflows/userdef_output.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
lcd ~/research/PLUTO/Real_Problems/Outflows
2wincmd w
tabedit ~/research/PLUTO/Real_Problems/Outflows/radiat.c
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
exe 'vert 1resize ' . ((&columns * 102 + 136) / 272)
exe '2resize ' . ((&lines * 48 + 31) / 62)
exe 'vert 2resize ' . ((&columns * 101 + 136) / 272)
argglobal
setlocal noautoindent
setlocal nobinary
setlocal bufhidden=
...
wincmd w
argglobal
edit ~/research/PLUTO/Real_Problems/Outflows/abundances.c
setlocal noautoindent
setlocal nobinary
setlocal bufhidden=
setlocal buflisted
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 49 - ((29 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
exe '2resize ' . ((&lines * 48 + 31) / 62)
exe 'vert 2resize ' . ((&columns * 101 + 136) / 272)
tabedit ~/research/PLUTO/Real_Problems/Outflows/cooling/rMuTable.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
1
normal! 0
lcd ~/research/PLUTO/Real_Problems/Outflows/cooling
wincmd w
argglobal
edit ~/research/PLUTO/Real_Problems/Outflows/cooling/rMuTable.c
setlocal noautoindent
setlocal nobinary
setlocal bufhidden=
setlocal buflisted
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 38 - ((23 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
38
...
exe 'vert 3resize ' . ((&columns * 22 + 136) / 272)
argglobal
setlocal noautoindent
setlocal nobinary
setlocal bufhidden=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 159 - ((2 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
159
...
wincmd w
argglobal
edit ~/research/AGN_Feedback/Jet/05kpc/definitions_usr.h
setlocal noautoindent
setlocal nobinary
setlocal bufhidden=
setlocal buflisted
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 12 - ((9 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
12
normal! 0
lcd ~/research/AGN_Feedback/Jet/05kpc
wincmd w
argglobal
edit ~/research/AGN_Feedback/Jet/05kpc/pluto.ini
setlocal noautoindent
setlocal nobinary
setlocal bufhidden=
setlocal buflisted
