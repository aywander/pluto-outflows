...
/* --------------------------------------------------------
   ...
   ------------------------------------------------------- */
    ...
    if (cmd_line.init_only == YES) {
        print1("Done Initialisation. Quitting. \n");
        last_step = 1;
    ...
    if (!cmd_line.init_only) print1("> Starting computation... \n\n");
    //---DM---//
...
/* =====================================================================
   ...
   ===================================================================== */
    ...
    //---DM 10Aug15: Stop junk print of times for only init_only ---//
    if (!cmd_line.init_only) {
